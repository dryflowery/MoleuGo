<script>
    ...
    /******************************사용자 작성 영역****************************/
    import ConvexHullSheet1 from "./sheet/ConvexHullSheet1.svelte";
    import ConvexHullSheet2 from "./sheet/ConvexHullSheet2.svelte";
    import ConvexHullSheet3 from "./sheet/ConvexHullSheet3.svelte";
    import ConvexHullSheet4 from "./sheet/ConvexHullSheet4.svelte";

    const leftSheets = {
        1: { forward: ConvexHullSheet1, backward: undefined },
        3: { forward: ConvexHullSheet3, backward: ConvexHullSheet2 },
    };

    const rightSheets = {
        1: { forward: ConvexHullSheet2, backward: ConvexHullSheet3 },
        3: { forward: ConvexHullSheet4, backward: undefined },
    };
