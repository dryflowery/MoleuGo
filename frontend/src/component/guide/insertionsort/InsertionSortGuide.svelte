<script>
    ...
    /******************************사용자 작성 영역****************************/
    import InsertionSortSheet1 from "./sheet/InsertionSortSheet1.svelte";
    import InsertionSortSheet2 from "./sheet/InsertionSortSheet2.svelte";

    const leftSheets = {
        1: { forward: InsertionSortSheet1, backward: undefined },
    };

    const rightSheets = {
        1: { forward: InsertionSortSheet2, backward: undefined },
    };
