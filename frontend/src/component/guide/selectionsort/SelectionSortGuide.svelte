<script>
    ...
    /******************************사용자 작성 영역****************************/
    import SelectionSortSheet1 from "./sheet/SelectionSortSheet1.svelte";
    import SelectionSortSheet2 from "./sheet/SelectionSortSheet2.svelte";

    const leftSheets = {
        1: { forward: SelectionSortSheet1, backward: undefined },
    };

    const rightSheets = {
        1: { forward: SelectionSortSheet2, backward: undefined },
    };

    let curPage = 1, minPage = 1, maxPage = 1;
    /******************************사용자 작성 영역****************************/
