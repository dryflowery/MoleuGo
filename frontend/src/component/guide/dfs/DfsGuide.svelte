<script>
    ...
    /******************************사용자 작성 영역****************************/
    import DfsSheet1 from "./sheet/DfsSheet1.svelte";
    import DfsSheet2 from "./sheet/DfsSheet2.svelte";

    const leftSheets = {
        1: { forward: DfsSheet1, backward: undefined },
    };

    const rightSheets = {
        1: { forward: DfsSheet2, backward: undefined },
    };
