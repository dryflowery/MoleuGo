<script>
    ...
    /******************************사용자 작성 영역****************************/
    import StackSheet1 from "./sheet/StackSheet1.svelte";
    import StackSheet2 from "./sheet/StackSheet2.svelte";
    import StackSheet3 from "./sheet/StackSheet3.svelte";
    import StackSheet4 from "./sheet/StackSheet4.svelte";

    const leftSheets = {
        1: { forward: StackSheet1, backward: undefined },
        3: { forward: StackSheet3, backward: StackSheet2 },
    };

    const rightSheets = {
        1: { forward: StackSheet2, backward: StackSheet3 },
        3: { forward: StackSheet4, backward: undefined }
    };
