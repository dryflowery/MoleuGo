<script>
    ...
    /******************************사용자 작성 영역****************************/
    import BfsSheet1 from "./sheet/BfsSheet1.svelte";
    import BfsSheet2 from "./sheet/BfsSheet2.svelte";

    const leftSheets = {
        1: { forward: BfsSheet1, backward: undefined },
    };

    const rightSheets = {
        1: { forward: BfsSheet2, backward: undefined },
    };
