<script>
    ...
    /******************************사용자 작성 영역****************************/
    import HeapSheet1 from "./sheet/HeapSheet1.svelte";
    import HeapSheet2 from "./sheet/HeapSheet2.svelte";
    import HeapSheet3 from "./sheet/HeapSheet3.svelte";
    import HeapSheet4 from "./sheet/HeapSheet4.svelte";

    const leftSheets = {
        1: { forward: HeapSheet1, backward: undefined },
        3: { forward: HeapSheet3, backward: HeapSheet2 },
    };

    const rightSheets = {
        1: { forward: HeapSheet2, backward: HeapSheet3 },
        3: { forward: HeapSheet4, backward: undefined },
    };
