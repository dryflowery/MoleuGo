<script>
    ...
    import BinarySearchSheet1 from "./sheet/BinarySearchSheet1.svelte";
    import BinarySearchSheet2 from "./sheet/BinarySearchSheet2.svelte";
    import BinarySearchSheet3 from "./sheet/BinarySearchSheet3.svelte";
    import BinarySearchSheet4 from "./sheet/BinarySearchSheet4.svelte";
    import BinarySearchSheet5 from "./sheet/BinarySearchSheet5.svelte";
    import BinarySearchSheet6 from "./sheet/BinarySearchSheet6.svelte";

    const leftSheets = {
        1: { forward: BinarySearchSheet1, backward: undefined },
        3: { forward: BinarySearchSheet3, backward: BinarySearchSheet2 },
        5: { forward: BinarySearchSheet5, backward: BinarySearchSheet4 },
    };

    const rightSheets = {
        1: { forward: BinarySearchSheet2, backward: BinarySearchSheet3 },
        3: { forward: BinarySearchSheet4, backward: BinarySearchSheet5 },
        5: { forward: BinarySearchSheet6, backward: undefined },
    };

    let curPage = 1, minPage = 1, maxPage = 5;
    /******************************사용자 작성 영역****************************/
