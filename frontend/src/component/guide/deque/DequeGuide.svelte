<script>
    ...
    /******************************사용자 작성 영역****************************/
    import DequeSheet1 from "./sheet/DequeSheet1.svelte";
    import DequeSheet2 from "./sheet/DequeSheet2.svelte";
    import DequeSheet3 from "./sheet/DequeSheet3.svelte";

    const leftSheets = {
        1: { forward: DequeSheet1, backward: undefined },
        3: { forward: DequeSheet3, backward: DequeSheet2 },
    };

    const rightSheets = {
        1: { forward: DequeSheet2, backward: DequeSheet3 },
        3: { forward: undefined, backward: undefined }
    };
